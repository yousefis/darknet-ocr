...
void train_detector(char *datacfg, char *cfgfile, char *weightfile, int *gpus, int ngpus, int clear)
{
    ...
    char *backup_directory = option_find_str(options, "backup", "/home/sahar/Documents/developments/Darknet-ocr/darknet/backup/");
    ...
    int count = 0;
    //while(i*imgs < N*120){
    // int aa=get_current_batch(net);
    // printf("before while %d, %d\n",net->max_batches,aa);
    // while(aa < net->max_batches){
    while(get_current_batch(net) < 641000){
